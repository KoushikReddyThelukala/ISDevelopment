...
if (WebUI.verifyElementText(findTestObject('Object Repository/Before Login/Registration Page/Passwords Do Not Match Validation Message'), "Passwords do not match") == true)
{
	println ("Password In The Password And Confirm Password Text Fields Are Not Same")
}