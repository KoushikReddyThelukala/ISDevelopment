...
if (WebUI.verifyElementText(findTestObject('Object Repository/Before Login/Registration Page/This field is required - Email'), "This field is required") == true)
{
	println ("Please Enter Email In The Email Text Field")
}

if (WebUI.verifyElementText(findTestObject('Object Repository/Before Login/Registration Page/This field is required - Password'), "This field is required") == true)
{
	println ("Please Enter Password In The Password Text Field")
}

if (WebUI.verifyElementText(findTestObject('Object Repository/Before Login/Registration Page/This field is required - Confirm Password'), "This field is required") == true)
{
	println ("Please Enter Password In The Confirm Password Text Field")
}